...
Você está dentro de `<home>/dev/Prometheus/`, engine Python do segundo cérebro do Sammy. Leia `CLAUDE.md` na raiz se precisar de contexto completo — este arquivo é apenas o resumo operacional.
...
1. **Paths:** dados em `~/vault/`, engine em `<home>/dev/Prometheus/`. Não inverter.
