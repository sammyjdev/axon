...
def test_resolve_provider_profile_rejects_free_alias(monkeypatch) -> None:
...
def test_resolve_provider_profile_normalizes_case_and_whitespace(monkeypatch) -> None:
    monkeypatch.setenv("AXON_PROVIDER_PROFILE", " BUDGET ")
    assert _resolve_provider_profile() == "budget"


def test_resolve_provider_profile_default_is_budget(monkeypatch) -> None:
